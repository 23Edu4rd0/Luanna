...
const GIFT_TEMPLATES: GiftTemplate[] = [
  ...
  { category: 'Cozinha', name: 'Jogo de pano de prato', description: 'Essencial para a rotina.', price: 70, imageUrl: '/images/products/pano.jpg' },
  { category: 'Cozinha', name: 'Liquidificador', description: 'Para sucos, massas e vitaminas.', price: 260, imageUrl: '/images/products/liquidificador.jpg' },
  ...
  { category: 'Quarto', name: 'Jogo de lençol cama queen', description: 'Conforto para a cama principal.', price: 180, imageUrl: '/images/products/quarto-01.jpg' },
  { category: 'Quarto', name: 'Jogo de lençol cama queen', description: 'Conjunto extra para o enxoval.', price: 180, imageUrl: '/images/products/quarto-02.jpg' },
  { category: 'Quarto', name: 'Jogo de cama queen', description: 'Camadas extras para noites aconchegantes.', price: 240, imageUrl: '/images/products/quarto-03.jpg' },
  { category: 'Quarto', name: 'Cobertor casal', description: 'Acolhimento para os dias frios.', price: 160, imageUrl: '/images/products/quarto-04.jpg' },
  { category: 'Quarto', name: 'Ferro de passar', description: 'Para roupas sempre alinhadas.', price: 170, imageUrl: '/images/products/quarto-05.jpg' },
  { category: 'Banheiro', name: 'Jogo de toalha de banho', description: 'Toalhas macias para o dia a dia.', price: 140, imageUrl: '/images/products/banheiro-01.jpg' },
  { category: 'Banheiro', name: 'Jogo de toalha de banho', description: 'Conjunto extra para o enxoval.', price: 140, imageUrl: '/images/products/banheiro-02.jpg' },
  { category: 'Banheiro', name: 'Toalhas de rosto (2 unidades)', description: 'Itens práticos para a rotina.', price: 75, imageUrl: '/images/products/banheiro-03.jpg' },
  { category: 'Banheiro', name: 'Lixeira inox', description: 'Acabamento discreto e resistente.', price: 120, imageUrl: '/images/products/banheiro-04.jpg' },
  { category: 'Banheiro', name: 'Tapete para banheiro', description: 'Mais conforto ao sair do banho.', price: 90, imageUrl: '/images/products/banheiro-05.jpg' },
  { category: 'Banheiro', name: 'Kit banheiro', description: 'Conjunto para deixar tudo coordenado.', price: 130, imageUrl: '/images/products/banheiro-06.jpg' },
];
